                ...
                {group.map(item => (
                  <View key={item.id} className='home-pin__item'>
                    ...
                    <View className='home-pin__item-info'>
                      <Text className='home-pin__item-price'>{`拼团价¥${item.group_price}`}</Text>
                      <Text className='home-pin__item-origin'>¥{item.price}</Text>
                    </View>
                    <View className='home-pin__item-num'>
                      <Text className='home-pin__item-num-txt'>{item.sales}人团</Text>
                    </View>
                  </View>
                ))}
              </SwiperItem>
